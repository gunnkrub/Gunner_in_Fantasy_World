import arcade.key
from codetect import player_in_block, player_in_block_list, move_player_on_block
class Player:
    JUMPING_VELOCITY = 15
    GRAVITY = 1
    ...
    def update(self, delta):
        ...
        block_hit = player_in_block_list(self.x, self.y, self.stage.block_list)
        if player_in_block(self.x, self.y, block_hit):
            self.jump_status = 0
        self.y,player_vy = move_player_on_block(self.x,self.y,block_hit,self.vy)
